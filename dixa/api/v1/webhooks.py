...
class WebhookResource(DixaResource):
    ...
    def patch(self, webhook_subscription_id: str, body):
        ...
        """
        return self.client.patch(f"{self._url}/{webhook_subscription_id}", body)
    ...
    def get(self, webhook_subscription_id: str):
        ...
        """
        return self.client.get(f"{self._url}/{webhook_subscription_id}")
    ...
    def list_delivery_statuses(self, webhook_subscription_id: str):
        ...
        """
        return self.client.get(f"{self._url}/{webhook_subscription_id}/delivery-status")
