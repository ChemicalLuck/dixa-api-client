...
class ConversationResource(DixaResource):
    ...
    def add_internal_note(self, conversation_id: str, body):
        ...
        """
        return self.client.post(f"{self._url}/{conversation_id}/notes", body)
    ...
    def add_internal_notes(self, conversation_id: str, body):
        ...
        """
        return self.client.post(f"{self._url}/{conversation_id}/notes/bulk", body)
    ...
    def add_message(self, conversation_id: str, body):
        ...
        """
        return self.client.post(f"{self._url}/{conversation_id}/messages", body)
    ...
    def anonymize(self, conversation_id: str):
        ...
        """
        return self.client.patch(f"{self._url}/{conversation_id}/anonymize")
    ...
    def get(self, conversation_id: str):
        ...
        """
        return self.client.get(f"{self._url}/{conversation_id}")
    ...
    def list_activity_logs(self, conversation_id: str):
        ...
        """
        return self.client.get(f"{self._url}/{conversation_id}/activitylog")
    ...
    def list_flows(self, conversation_id: str, query: dict | None = None):
        ...
        """
        return self.client.get(f"{self._url}/{conversation_id}/flows", query)
    ...
    def list_internal_notes(self, conversation_id: str):
        ...
        """
        return self.client.get(f"{self._url}/{conversation_id}/notes")
    ...
    def list_linked_conversations(self, conversation_id: str):
        ...
        """
        return self.client.get(f"{self._url}/{conversation_id}/linked")
    ...
    def list_messages(self, conversation_id: str):
        ...
        """
        return self.client.get(f"{self._url}/{conversation_id}/messages")
    ...
    def list_rating(self, conversation_id: str):
        ...
        """
        return self.client.get(f"{self._url}/{conversation_id}/rating")
    ...
    def list_tags(self, conversation_id: str):
        ...
        """
        return self.client.get(f"{self._url}/{conversation_id}/tags")
    ...
    def search(self, query):
        ...
        """
        return self.client.get(f"{self._url}/search", query)
