...
class AgentResource(DixaResource):
    ...
    def get(self, agent_id: str):
        ...
        """
        return self.client.get(f"{self._url}/{agent_id}")
    ...
    def update(self, agent_id, body):
        ...
        """
        return self.client.put(f"{self._url}/{agent_id}", body)
    ...
    def list_teams(self, agent_id: str):
        ...
        """
        return self.client.get(f"{self._url}/{agent_id}/teams")
    ...
    def patch(self, agent_id: str, body):
        ...
        """
        return self.client.patch(f"{self._url}/{agent_id}", body)
