...
class QueueResource(DixaResource):
    ...
    def assign(self, queue_id: str, body):
        ...
        """
        return self.client.patch(f"{self._url}/{queue_id}/members", body)
    ...
    def get(self, queue_id: str):
        ...
        """
        return self.client.get(f"{self._url}/{queue_id}")
    ...
    def list_agents(self, queue_id: str):
        ...
        """
        return self.client.get(f"{self._url}/{queue_id}/members")
