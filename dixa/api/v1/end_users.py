...
class EndUserResource(DixaResource):
    ...
    def anonymize(self, end_user_id: str):
        ...
        """
        return self.client.patch(f"{self._url}/{end_user_id}/anonymize")
    ...
    def create_bulk(self, body):
        ...
        """
        return self.client.post(f"{self._url}/bulk", body)
    ...
    def get(self, end_user_id: str):
        ...
        """
        return self.client.get(f"{self._url}/{end_user_id}")
    ...
    def list_conversations(self, end_user_id: str, query: dict | None = None):
        ...
        """
        return self.client.get(f"{self._url}/{end_user_id}/conversations", query)
    ...
    def patch(self, end_user_id: str, body):
        ...
        """
        return self.client.patch(f"{self._url}/{end_user_id}", body)
